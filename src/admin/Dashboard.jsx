      ...
      <div className="container xl:px-52 lg:px-32 md:px-5 xs:px-5 mt-5">
        <nav className="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-3" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            <li className="inline-flex items-center">
              <a href="#" className="inline-flex no-underline items-center text-sm font-medium text-gray-700 hover:text-pink-600 ">
            ...
            <li>
              <div className="flex items-center">
                ...
                <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-pink-600 md:ml-2 "></a>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6">
          <a href="/admin/mobile-legend" className=' no-underline'>
            <div className=" hover:text-pink-500 hover:bg-pink-200 border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Mobile Legends A</h2>
          ...
          <a href="/admin/mobile-legend-2" className=' no-underline'>
            <div className=" hover:text-pink-500 hover:bg-pink-200 border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Mobile Legends B</h2>
                  <p className="text-gray-700 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          ...
          <a href="/admin/genshin-impact" className=' no-underline'>
            <div className="hover:text-pink-500 hover:bg-pink-200 border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Genshin Impact Uid</h2>
                  <p className="text-gray-700 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
          </a>
          <a href="/admin/genshin-impact-2" className=' no-underline'>
            <div className="hover:text-pink-500 hover:bg-pink-200 border shadow rounded-lg p-6">
              <div className='flex gap-2'>
                <div className='py-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-9">
                ...
                <div>
                  <h2 className="text-xl font-bold mb-2">Genshin Impact Vilog</h2>
                  <p className="text-gray-700 text-lg font-bold">Edit</p>
                </div>
              </div>
            </div>
