    ...
    <>
      <footer className="p-4 sm:p-6 bg-white xl:px-52 lg:px-32 md:px-5 mt-5">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <div className="text-gray-600">
                ...
                <div className="mb-4">
                  <a href="/order/genshin-impact" className="text-gray-600 no-underline hover:underline">Genshin Impact</a>
                </div>
              </div>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">© {currentYear} <a href="#" className="text-gray-500 no-underline hover:underline">mutstore</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="#" className="text-gray-500 hover:text-gray-900" target="_blank" rel="noopener noreferrer">
      ...
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path fill="#ec4899" fill-opacity="1" d="M0,224L34.3,224C68.6,224,137,224,206,224C274.3,224,343,224,411,213.3C480,203,549,181,617,149.3C685.7,117,754,75,823,80C891.4,85,960,139,1029,138.7C1097.1,139,1166,85,1234,80C1302.9,75,1371,117,1406,138.7L1440,160L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
        </svg>
      </div>
    </>
  )
